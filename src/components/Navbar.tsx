      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item">
              <Link to="/filmes" className={`nav-link ${isActive('/filmes') ? 'active text-primary' : ''}`}>
                <i className="bi bi-camera-reels me-1"></i> Filmes
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/salas" className={`nav-link ${isActive('/salas') ? 'active text-primary' : ''}`}>
                <i className="bi bi-door-open me-1"></i> Salas
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/sessoes" className={`nav-link ${isActive('/sessoes') ? 'active text-primary' : ''}`}>
                <i className="bi bi-calendar-event me-1"></i> Sessões
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/lanches" className={`nav-link ${isActive('/lanches') ? 'active text-primary' : ''}`}>
